...
![Menu options](assets/f9-menu.png)
...
![Valeur de vente d'objet](assets/item-sell-value.png)
...
![Badge objets enregistrés](assets/recorded-items-badge.png)
...
![Affichage de la rareté des objets](assets/item-rarity-display.png)
...
![Noms des ennemis](assets/enemy-names.png)
...
![Préréglages de sommeil](assets/sleep-presets.png)
...
![Masquer l'indice des contrôles](assets/hide-controls-hint.png)
...
![Masquer le HUD en ADS](assets/hide-hud-on-ads.png)
